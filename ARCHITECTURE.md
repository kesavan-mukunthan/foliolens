...
54 modules. One line per module — first sentence of its docstring, extracted mechanically.
...
- `__init__.py` — Audit sub-package: data-quality investigation tools.
- `hole_months.py` — Hole-month audit — detect and classify internal zero-NAV months.
